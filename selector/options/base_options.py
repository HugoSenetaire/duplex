...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--net_selector', type=str, default='unet_32', help='specify generator architecture [resnet_9blocks | resnet_6blocks | unet_256 | unet_128 | unet_32, fc]')
        ...
        parser.add_argument('--f_theta_input_shape', type=int, nargs='+', default=[28, 28], help='Input shape for classifier')
        ...
        parser.add_argument('--f_theta_output_classes', type=int, default=10, help='Number of output classes for classifier')


        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='mnistduck', help='chooses how datasets are loaded. [mnistduck]')
