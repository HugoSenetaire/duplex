...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='/nrs/funke/senetaire/checkpoints_cyclegan/', help='models are saved here')
        ...
        parser.add_argument('--script_file', action='store_true', help='if specified, the classifier will be loaded as a torchscript model')
