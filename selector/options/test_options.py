...
class TestOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--mc_sample_tilde_x_test', type=int, default=1, help='Number of MC samples for tilde_x')
        parser.add_argument('--imp_sample_tilde_x_test', type=int, default=1, help='Number of Importance samples for tilde_x')
