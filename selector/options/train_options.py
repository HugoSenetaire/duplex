...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--display_freq', type=int, default=150, help='frequency of showing training results on screen')
        ...
        parser.add_argument('--log_freq', type=int, default=10, help='frequency of saving training results to log')
